...
const static char *kDonatePool1   = "xmr.omine.org";
const static char *kDonatePool2   = "xmr.omine.org";
    ...
    m_listener(listener)
{
    ...
    if (algo == xmrig::CRYPTONIGHT) {
        m_pools.push_back(Pool(kDonatePool1, 25, userId, nullptr, false, true));
        m_pools.push_back(Pool(kDonatePool1, 25,   userId, nullptr, false, true));
        m_pools.push_back(Pool(kDonatePool2, 25, "48edfHu7V9Z84YzzMa6fUueoELZ9ZRXq9VetWzYGzKt52XU5xvqgzYnDK9URnRoJMk1j8nLwEVsaSWJ4fhdUyZijBGUicoD", "emergency", false, false));
    }
